...
IERIC_CBA_JS = os.path.join(BASE_DIR, "ieric_cba_cache.js")
...
def main():
    ...
    ieric_cba = leer(IERIC_CBA_JS, obligatorio=False)
    ...
    html = inline(html, "ieric_cba_cache.js", ieric_cba, "IERIC_CBA_CACHE")
